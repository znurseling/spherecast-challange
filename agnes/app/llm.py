...
def chat_with_agnes(message: str, context: Optional[Dict] = None, history: Optional[List[Dict[str, str]]] = None) -> str:
    ...
    prompt = (
        ...
        "7. DECISIVENESS: When comparing suppliers or options, you MUST always make a definitive choice. Do not be indecisive or stay in the middle. Pick the best option based on the data, explicitly state the NAME of the preferred supplier from the database, and explain why.\n"
