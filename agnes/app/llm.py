...
def chat_with_agnes(message: str, context: Optional[Dict] = None, history: Optional[List[Dict[str, str]]] = None) -> str:
    ...
    prompt = (
        ...
        "7. DECISIVENESS: When comparing suppliers or options, you MUST always make a definitive choice. If multiple suppliers provide the same material, you MUST pick one specific supplier firm (e.g., 'Jost Chemical', 'ADM', 'Ashland', or 'Prinova USA') and explain why they are superior. NEVER recommend a material without naming the associated supplier from the context. IF YOU DO NOT NAME A SPECIFIC SUPPLIER FIRM, YOU HAVE FAILED THE USER.\n"
